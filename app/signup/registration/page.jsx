        ...
        <div className="netflix-sans-font-loaded">
          <div className="basicLayout notMobile firefox modernInApp signupSimplicity-planSelectionWithContext simplicity" dir="ltr" lang="en-IN">
            <div className="nfHeader noBorderHeader signupBasicHeader">
              <a href="https://www.netflix.com/" className="svg-nfLogo signupBasicHeader" data-uia="netflix-header-svg-logo">
              ...
              <a href="https://www.netflix.com/signout" className="authLinks signupBasicHeader" data-uia="header-signout-link">Sign Out</a>
            </div>
